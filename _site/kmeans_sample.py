...
temp, classified_points, means = cv2.kmeans(data=np.asarray(samples), K=2, bestLabels=None, criteria=(cv2.TERM_CRITERIA_EPS | cv2.TERM_CRITERIA_MAX_ITER, 1, 10), attempts=1, flags=cv2.KMEANS_RANDOM_CENTERS)
#Let OpenCV choose random centers for the clusters
